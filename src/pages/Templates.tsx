...
const Templates = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-pattern-light">
      {/* Header */}
        ...
        <Container maxWidth="2xl">
          <div className="mb-10 text-center">
            <h1 className="text-3xl md:text-4xl mb-4 animate-fade-in">
              Beautiful <span className="text-wedding-gold">Wedding Website</span> Templates
            </h1>
      ...
      {/* Footer */}
      <footer className="py-6 mt-12 border-t border-gray-100 bg-white/50">
        <Container>
